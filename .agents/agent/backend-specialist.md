...
model: inherit
version: 1.0.0
skills: clean-code, nodejs-best-practices, python-patterns, api-patterns, database-design, mcp-builder, lint-and-validate, powershell-windows, bash-linux, rust-pro, backend-architecture, collabnote-ddd-hexagonal, collabnote-event-driven, collabnote-realtime-collab, collabnote-resilience-observability, collabnote-data-strategy
---
