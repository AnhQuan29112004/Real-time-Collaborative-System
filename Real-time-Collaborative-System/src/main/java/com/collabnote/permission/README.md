...
Policy đọc/sửa/quản trị, document grants và public capabilities. Mọi adapter phải gọi policy; role workspace không tự cấp quyền tài liệu private.
...
- [DocumentPermissionController.java](controller/DocumentPermissionController.java)
- [DocumentPermissionResponse.java](dto/DocumentPermissionResponse.java)
- [GrantDocumentPermissionRequest.java](dto/GrantDocumentPermissionRequest.java)
- [DocumentGrantEntity.java](entity/DocumentGrantEntity.java)
- [DocumentShareLinkEntity.java](entity/DocumentShareLinkEntity.java)
- [DocumentPermissionMapper.java](mapper/DocumentPermissionMapper.java)
- [DocumentGrantRepository.java](repository/DocumentGrantRepository.java)
- [DocumentPermissionService.java](service/DocumentPermissionService.java)
- [PublicLinkService.java](service/PublicLinkService.java)
- [DocumentPermissionServiceImpl.java](service/impl/DocumentPermissionServiceImpl.java)
